...
import { Edit, Eye, Wrench, Trash2 } from 'lucide-react';
            ...
            <div className="space-y-2 text-sm">
                ...
                {ball.coverstockType && (
                    <div className="flex justify-between">
                        ...
                        <span className="font-medium text-right">{ball.coverstockType}</span>
                    </div>
                )}
                ...
                {ball.coreType && (
                    <div className="flex justify-between">
                        ...
                        <span className="font-medium text-right">{ball.coreType}</span>
                    </div>
                )}
